<?php
  require_once 'class/applicationside.php';
  $application= new application();
  $query_result=$application->allPublishedblog();
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <img src="admin/<?php echo $blog_info['blog_image'];?>" alt="" style="height:200px;width:250px;margin:20px;">
